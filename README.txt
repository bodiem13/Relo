...
The 'model' directory contains code related to the clustering pipeline and the generation and testing of various clustering models.
...
Finally, the 'Clustering_Pipeline-rerun_with_uniform_optimal_clusters.ipynb' file is identical to 'Clustering_Pipeline.ipynb', but it generates and evaluates five clustering models using each of the aforementioned algorithms and a parameter of 50 clusters for all.
